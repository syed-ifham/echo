...
export function DashboardSidebar() {
    ...
    const othersMenuItems: MenuItem[] = [
        ...
        },
        {
            ...
            url: "mailto:shadowsia960@gmail.com",
            icon: Headphones,
        },
    ];
        ...
        <Sidebar collapsible="icon">
            <SidebarHeader className="flex flex-col gap-4 pt-4">
                <div
                    ...
                    <Image src="/logo.svg" alt="echo" width={28} height={28} className="rounded-sm"/>
                    <span
                        className="group-data-[collapsible=icon]:hidden font-semibold text-lg tracking-tighter text-foreground">Echo</span>
